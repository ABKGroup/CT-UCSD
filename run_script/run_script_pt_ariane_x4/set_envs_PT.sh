...
export NUM_NETLISTS=6
export MAX_MACRO_COUNT=533
export DESIGN_NAME_0=ariane
export DESIGN_NAME_1=ariane
export DESIGN_NAME_2=ariane_X2_xflip
export DESIGN_NAME_3=ariane_X2_xflip
export DESIGN_NAME_4=ariane_X4_xflip_yflip
export DESIGN_NAME_5=ariane_X4_xflip_yflip
export DESIGN_NAME_E=ariane_X4_xflip_yflip
bash /workspace/run_script/cong_tsmc7.sh

export NETLIST_FILE_0=/workspace/Testcases/${DESIGN_NAME_0}/x_flip.pb.txt
export NETLIST_FILE_1=/workspace/Testcases/${DESIGN_NAME_1}/y_flip.pb.txt
export NETLIST_FILE_2=/workspace/Testcases/${DESIGN_NAME_2}/x_flip.pb.txt
export NETLIST_FILE_3=/workspace/Testcases/${DESIGN_NAME_3}/y_flip.pb.txt
export NETLIST_FILE_4=/workspace/Testcases/${DESIGN_NAME_4}/x_flip.pb.txt
export NETLIST_FILE_5=/workspace/Testcases/${DESIGN_NAME_5}/y_flip.pb.txt
export NETLIST_FILE_E=/workspace/Testcases/${DESIGN_NAME_E}/netlist.pb.txt

export INIT_PLACEMENT_0=/workspace/Testcases/${DESIGN_NAME_0}/x_flip_fixed.plc
export INIT_PLACEMENT_1=/workspace/Testcases/${DESIGN_NAME_1}/y_flip_fixed.plc
export INIT_PLACEMENT_2=/workspace/Testcases/${DESIGN_NAME_2}/x_flip_fixed.plc
export INIT_PLACEMENT_3=/workspace/Testcases/${DESIGN_NAME_3}/y_flip_fixed.plc
export INIT_PLACEMENT_4=/workspace/Testcases/${DESIGN_NAME_4}/x_flip_fixed.plc
export INIT_PLACEMENT_5=/workspace/Testcases/${DESIGN_NAME_5}/y_flip_fixed.plc
...
## The following is not used in the REVERB, TRAIN and EVAL Jobs.

...
def create_placement_cost(
    ...
    horizontal_routes_per_micron: float = 38.898,
    vertical_routes_per_micron: float = 39.891,
    macro_horizontal_routing_allocation: float = 15.625,
    macro_vertical_routing_allocation: float = 22.125,
    routes_per_congestion_grid: int = 1000,
    blockages: Optional[List[List[float]]] = None,
    fixed_macro_names_regex: Optional[List[str]] = None,
    legacy_congestion_grid: bool = True,
